...
- Business description rewrite (keyword-relevant, locally specific)
- Hours accuracy fix (incl. public holiday hours setup)
- NAP consistency check vs website/socials
- Initial photo upload (client-supplied or stock-appropriate — min. 10 photos)
- 2 initial Google Posts published
